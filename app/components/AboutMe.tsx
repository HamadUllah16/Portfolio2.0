...
function AboutMe() {
    return (
        <div className="py-5 md:px-14 sm:px-5 max-sm:px-5 flex flex-col gap-3">
            ...
            <p>
                In 2023, I enrolled in <strong>Metas Front-End Developer Specialization</strong>, sponsored by HEC. This program deepened my skills in <strong>React</strong>, <strong>Bootstrap</strong>, and <strong>CSS pre-processors</strong> through hands-on projects and rigorous assessments. Completing the specialization in six months was a rewarding challenge, capped by creating a portfolio that showcased what I&apos;d learned. React unlocked my creativity—it showed me that frontend development is much more than &quot;changing the color of a button&quot;; it&apos;s about crafting dynamic, interactive user interfaces with robust business logic.
            </p>
            <p>
