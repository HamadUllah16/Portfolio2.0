...
export function CompanyHoverCard({ companyName, companyLogo, companyDescription, companyJoinDate, companyLink, role, size }: TCompany) {
    return (
        <Link href={companyLink} target="_blank" rel="noopener noreferrer">
            <HoverCard>
                <HoverCardTrigger asChild>
                    <Button variant="link" size={size} className="p-0 h-fit">{role} {companyName}</Button>
                </HoverCardTrigger>
